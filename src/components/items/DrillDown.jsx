...
const TABLE_1 = [
  { rollMin:  1, rollMax: 20,  label: '01–20', category: 'Magical Liquids',             table: 'A', dice: 'd1000' },
  { rollMin: 21, rollMax: 35,  label: '21–35', category: 'Scrolls',                     table: 'B', dice: 'd1000' },
  { rollMin: 36, rollMax: 40,  label: '36–40', category: 'Rings',                       table: 'C', dice: 'd1000' },
  { rollMin: 41, rollMax: 45,  label: '41–45', category: 'Rods',                        table: 'D', dice: 'd1000' },
  { rollMin: 46, rollMax: 50,  label: '46–50', category: 'Staves',                      table: 'E', dice: 'd1000' },
  { rollMin: 51, rollMax: 55,  label: '51–55', category: 'Wands',                       table: 'F', dice: 'd1000' },
  { rollMin: 56, rollMax: 60,  label: '56–60', category: 'Books & Tomes',               table: 'G', dice: 'd1000' },
  { rollMin: 61, rollMax: 65,  label: '61–65', category: 'Gems & Jewelry',              table: 'H', dice: 'd1000' },
  { rollMin: 66, rollMax: 68,  label: '66–68', category: 'Clothing',                    table: 'I', dice: 'd1000' },
  { rollMin: 69, rollMax: 72,  label: '69–72', category: 'Boots, Gloves & Accessories', table: 'J', dice: 'd1000' },
  { rollMin: 73, rollMax: 74,  label: '73–74', category: 'Girdles & Helmets',           table: 'K', dice: 'd1000' },
  { rollMin: 75, rollMax: 77,  label: '75–77', category: 'Bags, Bands & Bottles',       table: 'L', dice: 'd1000' },
  { rollMin: 78, rollMax: 80,  label: '78–80', category: 'Dusts & Stones',              table: 'M', dice: 'd1000' },
  { rollMin: 81, rollMax: 83,  label: '81–83', category: 'Household Items',             table: 'N', dice: 'd1000' },
  { rollMin: 84, rollMax: 85,  label: '84–85', category: 'Musical Instruments',         table: 'O', dice: 'd1000' },
  { rollMin: 86, rollMax: 87,  label: '86–87', category: 'Weird Stuff',                 table: 'P', dice: 'd1000' },
  { rollMin: 88, rollMax: 89,  label: '88–89', category: 'Humorous Items',              table: 'Q', dice: 'd1000' },
  ...
  { rollMin:100, rollMax:100,  label: '00',    category: 'Artifacts & Relics',          table: 'T', dice: 'd1000' },
];
